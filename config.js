...
module.exports = {
    ...
    BOT_INFO: process.env.BOT_INFO || 'FelixKarayel;spio347;905340770299;https://i.imgur.com/f0IeiDn.png;https://wa.me/905340770299',
    RBG_KEY: process.env.RBG_KEY || '',
    ALLOWED: process.env.ALLOWED || '91,94,212',
    CHATBOT: process.env.CHATBOT || 'off',
    HANDLERS: process.env.HANDLERS || '.,',
    STICKER_DATA: process.env.STICKER_DATA,
    BOT_NAME: process.env.BOT_NAME || 'spio347',
    AUDIO_DATA: process.env.AUDIO_DATA === undefined || process.env.AUDIO_DATA === "private" ? 'Spio347;Spio347bot;https://i.imgur.com/f0IeiDn.png' : process.env.AUDIO_DATA,
